...
Utility_referFriends_args = function(args) {
  this.authenticationToken = null;
  this.referredEmails = null;
  if (args) {
    if (args.authenticationToken !== undefined) {
      this.authenticationToken = args.authenticationToken;
    }
    if (args.referredEmails !== undefined) {
      this.referredEmails = args.referredEmails;
    }
  }
};
Utility_referFriends_args.prototype = {};
Utility_referFriends_args.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i5 = 0; _i5 < _size0; ++_i5)
        {
          ...
          this.referredEmails.push(elem6);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
Utility_referFriends_args.prototype.write = function(output) {
  output.writeStructBegin('Utility_referFriends_args');
  if (this.authenticationToken !== null && this.authenticationToken !== undefined) {
    output.writeFieldBegin('authenticationToken', Thrift.Type.STRING, 1);
    output.writeString(this.authenticationToken);
    output.writeFieldEnd();
  }
  if (this.referredEmails !== null && this.referredEmails !== undefined) {
    output.writeFieldBegin('referredEmails', Thrift.Type.LIST, 2);
    output.writeListBegin(Thrift.Type.STRING, this.referredEmails.length);
    for (var iter7 in this.referredEmails)
    {
      if (this.referredEmails.hasOwnProperty(iter7))
      {
        iter7 = this.referredEmails[iter7];
...
Utility_referFriends_result = function(args) {
  this.success = null;
  this.userException = null;
  this.systemException = null;
  if (args instanceof EDAMUserException) {
...
Utility_referFriends_result.prototype = {};
Utility_referFriends_result.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
Utility_referFriends_result.prototype.write = function(output) {
  output.writeStructBegin('Utility_referFriends_result');
  if (this.success !== null && this.success !== undefined) {
...
UtilityClient.prototype.referFriends = function(authenticationToken, referredEmails, callback) {
  if (callback === undefined) {
    this.send_referFriends(authenticationToken, referredEmails);
    return this.recv_referFriends();
  } else {
    var postData = this.send_referFriends(authenticationToken, referredEmails, true);
    return this.output.getTransport()
      .send(this, postData, arguments, this.recv_referFriends);
  }
};

UtilityClient.prototype.send_referFriends = function(authenticationToken, referredEmails, callback) {
  this.output.writeMessageBegin('referFriends', Thrift.MessageType.CALL, this.seqid);
  var args = new Utility_referFriends_args();
  args.authenticationToken = authenticationToken;
...
UtilityClient.prototype.recv_referFriends = function() {
  var ret = this.input.readMessageBegin();
  var fname = ret.fname;
  var mtype = ret.mtype;
  var rseqid = ret.rseqid;
  ...
  var result = new Utility_referFriends_result();
  result.read(this.input);
  this.input.readMessageEnd();
  ...
  throw 'referFriends failed: unknown result';
};
