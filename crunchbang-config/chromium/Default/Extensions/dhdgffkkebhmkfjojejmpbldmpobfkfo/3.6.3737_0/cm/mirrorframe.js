...
function MirrorFrame(place, options, handlers, events, i18n) {
    ...
    if (!options.noButtons) {
        makeButton(i18n.search, "search", false);
        makeButton(i18n.replace, "replace");
        makeButton(i18n.jump, "jump");
        makeButton(i18n.macro, "macro");
        makeButton(i18n.reindentall, "reindentall");
    }
...
MirrorFrame.prototype = {
    ...
    reindentall: function() {
        for (var i = 0; i <= this.mirror.lineCount(); i++) {
            this.mirror.indentLine(i, "smart");
        }
    }
};
