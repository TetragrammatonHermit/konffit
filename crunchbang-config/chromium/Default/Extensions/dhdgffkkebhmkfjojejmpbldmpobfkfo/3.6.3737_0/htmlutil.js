...
}else{z=(z?z+" ":"")+w}y.setAttribute("class",z)};Registry.register("htmlutil","3737.6",{addClass:j,toggleClass:q,createValidation:k,createImageText:n,createImage:u,createFavicon:i,createFileInput:g,createTextarea:c,createInput:r,createPassword:o,createCheckbox:m,createDropDown:b,createScriptStartDropDown:v,createImageButton:s,createButton:p,createPosition:l,createSearchBox:a})
});