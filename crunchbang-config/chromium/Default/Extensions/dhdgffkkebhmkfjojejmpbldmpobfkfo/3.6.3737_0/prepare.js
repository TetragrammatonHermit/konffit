...
}c.DB.USE=c.DB.DEFAULT;try{if(c.HTML5.LOCALSTORAGE){c.DB.USE=c.HTML5.LOCALSTORAGE.getItem(c.CONSTANTS.STORAGE.TYPE)||c.DB.DEFAULT
...
if(h){h()}});return c}};Registry.register("prepare","3737.6",c)
})();