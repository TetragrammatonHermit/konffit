...
SharedNotebook = function(args) {
  ...
  if (args) {
    ...
    if (args.serviceJoined !== undefined) {
      this.serviceJoined = args.serviceJoined;
    }
  }
};
...
SharedNotebook.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 16:
      if (ftype == Thrift.Type.I64) {
        this.serviceJoined = input.readI64().value;
      } else {
        input.skip(ftype);
      }
      break;
...
SharedNotebook.prototype.write = function(output) {
  ...
  if (this.serviceJoined !== null && this.serviceJoined !== undefined) {
    output.writeFieldBegin('serviceJoined', Thrift.Type.I64, 16);
    output.writeI64(this.serviceJoined);
    output.writeFieldEnd();
  }
  output.writeFieldStop();
  output.writeStructEnd();
