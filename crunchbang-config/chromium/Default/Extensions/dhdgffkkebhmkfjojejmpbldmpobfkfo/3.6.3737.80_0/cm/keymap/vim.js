...
(function() {
  ...
  var Vim = function() {
    ...
    var defaultExCommandMap = [
      ...
      { name: 'saveI', shortName: 'w!', type: 'builtIn' },
      { name: 'save', shortName: 'w', type: 'builtIn' },
      { name: 'closeI', shortName: 'q!', type: 'builtIn' },
      { name: 'close', shortName: 'q', type: 'builtIn' },
      { name: 'saveAndCloseI', shortName: 'wq!', type: 'builtIn' },
      { name: 'saveAndClose', shortName: 'wq', type: 'builtIn' },
      ...
      matchCommand_: function(commandName) {
        ...
        for (var i = commandName.length; i > 0; i--) {
          ...
          if (this.commandMap_[prefix]) {
            ...
            if (command.shortName.indexOf(commandName) === 0) {
              return command;
            }
          }
        }
    ...
    var exCommands = {
      ...
      save: function(cm, params) {
        this.write(cm, params);
      },
      saveAndClose: function(cm, params) {
        this.write(cm, params);
        this.close(cm, params);
      },
      close: function(cm, params) {
        if (CodeMirror.commands.close) {
          // If a save command is defined, call it.
            CodeMirror.commands.close(cm, params.argString == '!');
        } else {
          // Saves to text area if no save command is defined.
          cm.close(params.argString == '!');
        }
      },
      write: function(cm, params, force) {
        if (CodeMirror.commands.save) {
          // If a save command is defined, call it.
            CodeMirror.commands.save(cm, params.argString == '!');
        } else {
          // Saves to text area if no save command is defined.
          cm.save(params.argString == '!');
        }
      },
